...
void main() {
    ...
    if (SampleCount >= MaxSampleCount) {
        ...
        float sample_i = float(SampleCount % sqrt_max_samples) * inv_sqrt_max_samples - 0.5; // [-0.5, 0.5]
        float sample_j = float(SampleCount / sqrt_max_samples) * inv_sqrt_max_samples - 0.5; // [-0.5, 0.5]
