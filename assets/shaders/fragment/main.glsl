...
uniform uint MaxSampleCount = 1000u;
uniform vec3 Origin;
...
void main() {
    ...
    Scene scene;
    scene.spheres[scene.sphere_count++] = Sphere(vec3(0.0, -100, 0.0), 100.0);
    scene.spheres[scene.sphere_count++] = Sphere(vec3(0.0, 0.5, 0.0), 0.5);
